...
scriptblock instead:
    ...
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/toperux/t4-ai-setup/main/install-copilot-windows.ps1))) -SkipToolchain
...
param(
    ...
    # Anything else is forwarded to setup-copilot-windows.ps1.
...
try {
    ...
    $installer = Join-Path $root.FullName "copilot\windows\setup-copilot-windows.ps1"

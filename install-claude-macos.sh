...
# macOS. Intended to be fetched and executed in one line:
#
...
[ "$(uname -s)" = "Darwin" ] || { echo "This installer targets macOS. On WSL use install-claude-wsl.sh." >&2; exit 1; }
...
INSTALLER="$WORKSPACE/repo/claude/macos/setup-claude-macos.sh"
